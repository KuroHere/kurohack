...
import me.kurohere.kurohack.features.modules.client.Capes;
import me.kurohere.kurohack.features.modules.client.ClickGui;
import me.kurohere.kurohack.features.modules.client.Colors;
import me.kurohere.kurohack.features.modules.client.Components;
import me.kurohere.kurohack.features.modules.client.Cosmetics;
...
import me.kurohere.kurohack.features.modules.client.Media;
import me.kurohere.kurohack.features.modules.client.Notifications;
import me.kurohere.kurohack.features.modules.client.Screens;
import me.kurohere.kurohack.features.modules.client.ServerModule;
import me.kurohere.kurohack.features.modules.combat.AntiCrystal;
import me.kurohere.kurohack.features.modules.combat.AntiTrap;
import me.kurohere.kurohack.features.modules.combat.AnvilAura;
import me.kurohere.kurohack.features.modules.combat.ArmorMessage;
import me.kurohere.kurohack.features.modules.combat.Auto32k;
import me.kurohere.kurohack.features.modules.combat.AutoArmor;
import me.kurohere.kurohack.features.modules.combat.AutoCrystal;
import me.kurohere.kurohack.features.modules.combat.AutoTrap;
import me.kurohere.kurohack.features.modules.combat.BedBomb;
import me.kurohere.kurohack.features.modules.combat.BowSpam;
import me.kurohere.kurohack.features.modules.combat.Crasher;
import me.kurohere.kurohack.features.modules.combat.Criticals;
import me.kurohere.kurohack.features.modules.combat.GodModule;
import me.kurohere.kurohack.features.modules.combat.HoleFiller;
import me.kurohere.kurohack.features.modules.combat.Killaura;
import me.kurohere.kurohack.features.modules.combat.Offhand;
import me.kurohere.kurohack.features.modules.combat.Selftrap;
import me.kurohere.kurohack.features.modules.combat.Surround;
import me.kurohere.kurohack.features.modules.combat.Webaura;
import me.kurohere.kurohack.features.modules.misc.AntiPackets;
import me.kurohere.kurohack.features.modules.misc.AntiVanish;
import me.kurohere.kurohack.features.modules.misc.AutoGG;
import me.kurohere.kurohack.features.modules.misc.AutoLog;
import me.kurohere.kurohack.features.modules.misc.AutoReconnect;
import me.kurohere.kurohack.features.modules.misc.AutoRespawn;
import me.kurohere.kurohack.features.modules.misc.BetterPortals;
import me.kurohere.kurohack.features.modules.misc.BuildHeight;
import me.kurohere.kurohack.features.modules.misc.Bypass;
import me.kurohere.kurohack.features.modules.misc.ChatModifier;
import me.kurohere.kurohack.features.modules.misc.Companion;
import me.kurohere.kurohack.features.modules.misc.Exploits;
import me.kurohere.kurohack.features.modules.misc.ExtraTab;
import me.kurohere.kurohack.features.modules.misc.Godmode;
import me.kurohere.kurohack.features.modules.misc.KitDelete;
import me.kurohere.kurohack.features.modules.misc.Logger;
import me.kurohere.kurohack.features.modules.misc.MCF;
import me.kurohere.kurohack.features.modules.misc.MobOwner;
import me.kurohere.kurohack.features.modules.misc.NoAFK;
import me.kurohere.kurohack.features.modules.misc.NoHandShake;
import me.kurohere.kurohack.features.modules.misc.NoRotate;
import me.kurohere.kurohack.features.modules.misc.NoSoundLag;
import me.kurohere.kurohack.features.modules.misc.Nuker;
import me.kurohere.kurohack.features.modules.misc.PingSpoof;
import me.kurohere.kurohack.features.modules.misc.RPC;
import me.kurohere.kurohack.features.modules.misc.Spammer;
import me.kurohere.kurohack.features.modules.misc.ToolTips;
import me.kurohere.kurohack.features.modules.misc.Tracker;
import me.kurohere.kurohack.features.modules.misc.Translator;
import me.kurohere.kurohack.features.modules.movement.AntiLevitate;
import me.kurohere.kurohack.features.modules.movement.AutoWalk;
import me.kurohere.kurohack.features.modules.movement.ElytraFlight;
import me.kurohere.kurohack.features.modules.movement.FastSwim;
import me.kurohere.kurohack.features.modules.movement.Flight;
import me.kurohere.kurohack.features.modules.movement.HoleTP;
import me.kurohere.kurohack.features.modules.movement.IceSpeed;
import me.kurohere.kurohack.features.modules.movement.LagBlock;
import me.kurohere.kurohack.features.modules.movement.LongJump;
import me.kurohere.kurohack.features.modules.movement.NoFall;
import me.kurohere.kurohack.features.modules.movement.NoSlowDown;
import me.kurohere.kurohack.features.modules.movement.Phase;
import me.kurohere.kurohack.features.modules.movement.SafeWalk;
import me.kurohere.kurohack.features.modules.movement.Speed;
import me.kurohere.kurohack.features.modules.movement.Sprint;
import me.kurohere.kurohack.features.modules.movement.StairSpeed;
import me.kurohere.kurohack.features.modules.movement.Static;
import me.kurohere.kurohack.features.modules.movement.Step;
import me.kurohere.kurohack.features.modules.movement.Strafe;
import me.kurohere.kurohack.features.modules.movement.TPSpeed;
import me.kurohere.kurohack.features.modules.movement.TestPhase;
import me.kurohere.kurohack.features.modules.movement.Velocity;
import me.kurohere.kurohack.features.modules.player.Blink;
import me.kurohere.kurohack.features.modules.player.BlockTweaks;
import me.kurohere.kurohack.features.modules.player.EchestBP;
import me.kurohere.kurohack.features.modules.player.FakePlayer;
import me.kurohere.kurohack.features.modules.player.FastPlace;
import me.kurohere.kurohack.features.modules.player.Freecam;
import me.kurohere.kurohack.features.modules.player.Jesus;
import me.kurohere.kurohack.features.modules.player.LiquidInteract;
import me.kurohere.kurohack.features.modules.player.MCP;
import me.kurohere.kurohack.features.modules.player.MultiTask;
import me.kurohere.kurohack.features.modules.player.NoDDoS;
import me.kurohere.kurohack.features.modules.player.NoHunger;
import me.kurohere.kurohack.features.modules.player.Reach;
import me.kurohere.kurohack.features.modules.player.Replenish;
import me.kurohere.kurohack.features.modules.player.Scaffold;
import me.kurohere.kurohack.features.modules.player.Speedmine;
import me.kurohere.kurohack.features.modules.player.TimerSpeed;
import me.kurohere.kurohack.features.modules.player.TpsSync;
import me.kurohere.kurohack.features.modules.player.TrueDurability;
import me.kurohere.kurohack.features.modules.player.XCarry;
import me.kurohere.kurohack.features.modules.player.Yaw;
import me.kurohere.kurohack.features.modules.render.BlockHighlight;
import me.kurohere.kurohack.features.modules.render.CameraClip;
import me.kurohere.kurohack.features.modules.render.Chams;
import me.kurohere.kurohack.features.modules.render.ESP;
import me.kurohere.kurohack.features.modules.render.Fullbright;
import me.kurohere.kurohack.features.modules.render.HandColor;
import me.kurohere.kurohack.features.modules.render.HoleESP;
import me.kurohere.kurohack.features.modules.render.LogoutSpots;
import me.kurohere.kurohack.features.modules.render.Nametags;
import me.kurohere.kurohack.features.modules.render.NoRender;
import me.kurohere.kurohack.features.modules.render.OffscreenESP;
import me.kurohere.kurohack.features.modules.render.PortalESP;
import me.kurohere.kurohack.features.modules.render.Ranges;
import me.kurohere.kurohack.features.modules.render.Skeleton;
import me.kurohere.kurohack.features.modules.render.SmallShield;
import me.kurohere.kurohack.features.modules.render.StorageESP;
import me.kurohere.kurohack.features.modules.render.Tracer;
import me.kurohere.kurohack.features.modules.render.Trajectories;
import me.kurohere.kurohack.features.modules.render.VoidESP;
import me.kurohere.kurohack.features.modules.render.XRay;
