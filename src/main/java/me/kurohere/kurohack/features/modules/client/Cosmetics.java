...
extends Module {
    ...
    public void onRenderPlayer(RenderPlayerEvent.Post event) {
        if (!kuro.cosmeticsManager.hasCosmetics(event.getEntityPlayer()) || EntityUtil.isFakePlayer(event.getEntityPlayer())) {
            return;
        }
        for (ModelBase model : kuro.cosmeticsManager.getRenderModels(event.getEntityPlayer())) {
