...
extends Module {
    ...
    private void doHoleFill() {
        ...
        if (this.midSafeHoles.getValue().booleanValue()) {
            object = kuro.holeManager.getMidSafety();
            synchronized (object) {
                targets = new ArrayList<BlockPos>(kuro.holeManager.getMidSafety());
            }
        }
        object = kuro.holeManager.getHoles();
        synchronized (object) {
            targets = new ArrayList<BlockPos>(kuro.holeManager.getHoles());
        }
