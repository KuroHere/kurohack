...
extends Module {
    ...
    public void onKeyInput(InputEvent.KeyInputEvent event) {
        ...
        if (Keyboard.getEventKeyState() && !(Auto32k.mc.currentScreen instanceof kurohackGui) && this.switchBind.getValue().getKey() == Keyboard.getEventKey() && this.withBind.getValue().booleanValue()) {
            if (this.switching) {
                this.resetFields();
                this.switching = true;
            }
