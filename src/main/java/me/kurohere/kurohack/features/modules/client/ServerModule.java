...
import me.kurohere.kurohack.mixin.mixins.accessors.IC00Handshake;
...
extends Module {
    public Setting<String> ip = this.register(new Setting<String>("kuroIP", "0.0.0.0.0"));
    ...
    public ServerModule() {
        super("PingBypass", "Manages kuro`s internal Server", Module.Category.CLIENT, false, false, true);
        instance = this;
    }
