...
extends Module {
    ...
    public void onKeyInput(InputEvent.KeyInputEvent event) {
        if (Keyboard.getEventKeyState() && !(AutoArmor.mc.currentScreen instanceof kuro) && this.elytraBind.getValue().getKey() == Keyboard.getEventKey()) {
    ...
    public void onTick() {
        ...
        if (this.timer.passedMs((int)((float)this.delay.getValue().intValue() * (this.tps.getValue() != false ? kuro.serverManager.getTpsFactor() : 1.0f)))) {
            if (!this.taskList.isEmpty()) {
