...
extends Command {
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : kuro.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module : kuro.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = kuro.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = kuro.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
